  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-center md:justify-center gap-[30px] px-[20px] fixed top-0 left-0 z-[9999] bg-[#fff9f6] overflow-visible">
      ...
      <div className="flex items-center gap-4">
        {showSearch?<ImCross size={20} className="text-[#ff4d2d] md:hidden" onClick={()=> setShowSearch(false)} />:  <IoIosSearch size={25} className="text-[#ff4d2d] md:hidden" onClick={()=> setShowSearch(true)} />}
